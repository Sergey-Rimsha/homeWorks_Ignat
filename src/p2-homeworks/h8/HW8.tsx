...
function HW8() {
    ...
    const sortDown = () => setPeople(homeWorkReducer(initialPeople, {type: 'check', payload: 'down'}))
    const sortAge = () => setPeople(homeWorkReducer(initialPeople, {type: 'age', payload: 18}))
